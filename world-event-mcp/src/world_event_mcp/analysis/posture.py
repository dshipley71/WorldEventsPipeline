...
logger = logging.getLogger("world-event-mcp.analysis.posture")
...
def _score_economic() -> tuple[float, list[str]]:
    """Score economic domain (shipping data unavailable - no paid API)."""
    return 0.0, []
...
async def fetch_strategic_posture(fetcher) -> dict:
    ...
    eco_score, eco_signals = _score_economic()
