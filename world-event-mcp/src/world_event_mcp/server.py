...
logger = logging.getLogger("world-event-mcp")

server = Server("world-event-mcp")
cache = Cache()
...
TOOLS: list[Tool] = [
    ...
    Tool(
        ...
        description="Get free macro sentiment signals: Crypto Fear & Greed Index and Bitcoin mempool fee rates.",
            ...
            "properties": {
                ...
                "mode": {
                    ...
                    "description": (
                        ...
                        "timelinevol — normalized volume timeline; "
                        "timelinevolraw — raw article-count timeline; "
                        "timelinetone — average tone timeline"
                    ),
                    "enum": ["artlist", "timelinevol", "timelinevolraw", "timelinetone"],
                    "default": "artlist",
                },
                "limit": {"type": "integer", "description": "Max records for artlist mode (default 50)", "default": 50},
                "timespan": {
                    "type": "string",
                    "description": (
                        "GDELT timespan for timeline modes (e.g. '90d', '30d', '7d'). "
                        "Ignored for artlist mode."
                    ),
                },
            },
        },
    ...
    Tool(
        ...
        description="Generate a country intelligence brief using World Bank public data (GDP, inflation). No API key required.",
        inputSchema={
            "type": "object",
            "properties": {
    ...
    Tool(
        ...
        description="Compute Country Instability Index v2 (0-100) from security and information domain signals (military flights, internet outages, news velocity). No API key required.",
        inputSchema={
            "type": "object",
            "properties": {
    ...
    match name:
        ...
        case "intel_status":
            return {
                ...
                "sources": {
                    "markets": ["alternative-me", "mempool"],
                    "economic": ["world-bank"],
                    "natural": ["usgs"],
                    "conflict": ["hdx"],
                    ...
                    "intelligence": ["world-bank", "hdx", "usgs", "adsblol", "opensky", "ioda"],
...
async def _run() -> None:
    logger.info("World Event MCP Server starting (%d tools)", len(TOOLS))
