"""Conflict and crisis data sources for world-event-mcp.

Fetches humanitarian dataset metadata (HDX) for the world-event-mcp server.
No API key required.
"""
...
logger = logging.getLogger("world-event-mcp.sources.conflict")
