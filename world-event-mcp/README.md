...
```bash
# Clone
git clone https://github.com/marc-shade/world-event-mcp.git
cd world-event-mcp
...
```json
{
  "mcpServers": {
    "world-event-mcp": {
      "command": "/path/to/venv/bin/world-event-mcp",
      "env": {}
    }
  }
}
...
1. Create `src/world_event_mcp/sources/your_source.py`
