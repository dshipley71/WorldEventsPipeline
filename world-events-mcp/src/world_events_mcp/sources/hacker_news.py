"""Hacker News top stories source for world-events-mcp.
...
logger = logging.getLogger("world-events-mcp.sources.hacker_news")
...
async def fetch_hacker_news(
    ...
    if top_ids is None or not isinstance(top_ids, list):
        return {"stories": [], "count": 0, "source": "hackernews", "timestamp": utc_now_iso()}
