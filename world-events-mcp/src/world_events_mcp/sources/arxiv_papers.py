"""arXiv recent papers source for world-events-mcp.
...
logger = logging.getLogger("world-events-mcp.sources.arxiv_papers")
...
async def fetch_arxiv_papers(
    ...
    if xml_text is None:
        return {"papers": [], "count": 0, "source": "arxiv", "timestamp": utc_now_iso()}
