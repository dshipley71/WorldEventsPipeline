"""Aviation data sources for world-events-mcp.
...
logger = logging.getLogger("world-events-mcp.sources.aviation")
...
async def fetch_domestic_flights(fetcher: Fetcher) -> dict:
    ...
    Anonymous access provides up to 400 API credits/day.
    """
    data = await fetcher.get_json(
        _OPENSKY_STATES_URL,
