"""Nuclear test site seismic monitoring source for world-events-mcp.
...
logger = logging.getLogger("world-events-mcp.sources.nuclear")
    ...
    async def _check_site(site: dict) -> dict:
        ...
        if data is not None:
            for feature in data.get("features", []):
                ...
                distance = haversine_km(lat, lon, eq_lat, eq_lon)
