...
logger = logging.getLogger("world-events-mcp.sources.usa_spending")
...
async def fetch_usa_spending(
    ...
    if data is None or not isinstance(data, dict):
        return {"agencies": [], "count": 0, "fiscal_year": fiscal_year, "source": "usaspending", "timestamp": utc_now_iso()}
