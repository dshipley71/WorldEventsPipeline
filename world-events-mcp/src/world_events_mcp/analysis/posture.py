...
logger = logging.getLogger("world-events-mcp.analysis.posture")
...
async def fetch_strategic_posture(fetcher) -> dict:
    ...
    """
    from ..sources import space_weather, infrastructure, cyber, health, climate
    ...
    (
        ...
        safe_fetch(intelligence.fetch_military_surge(fetcher), "military_surge", context="Posture"),
        safe_fetch(military.fetch_theater_posture(fetcher), "theater_posture", context="Posture"),
        safe_fetch(intelligence.fetch_instability_index(fetcher), "instability", context="Posture"),
        safe_fetch(intelligence.fetch_hotspot_escalation(fetcher), "hotspot_escalation", context="Posture"),
        safe_fetch(infrastructure.fetch_cable_health(fetcher), "cable_health", context="Posture"),
        safe_fetch(infrastructure.fetch_internet_outages(fetcher), "internet_outages", context="Posture"),        safe_fetch(cyber.fetch_cyber_threats(fetcher), "cyber", context="Posture"),
        safe_fetch(health.fetch_disease_outbreaks(fetcher), "health", context="Posture"),
        safe_fetch(climate.fetch_climate_anomalies(fetcher), "climate", context="Posture"),
        safe_fetch(space_weather.fetch_space_weather(fetcher), "space_weather", context="Posture"),
    )
