...
logger = logging.getLogger("world-events-mcp.analysis.world_brief")
...
async def fetch_world_brief(fetcher) -> dict:
    ...
    (
        ...
        safe_fetch(fetch_strategic_posture(fetcher), "strategic_posture", context="World brief"),
        safe_fetch(intelligence.fetch_focal_points(fetcher), "focal_points", context="World brief"),
        safe_fetch(fetch_news_clusters(fetcher), "news_clusters", context="World brief"),
        safe_fetch(intelligence.fetch_temporal_anomalies(fetcher), "temporal_anomalies", context="World brief"),
        safe_fetch(fetch_keyword_spikes(fetcher), "keyword_spikes", context="World brief"),
    )
