...
# World Events MCP Server

[![MCP](https://img.shields.io/badge/MCP-Compatible-blue)](https://modelcontextprotocol.io)
[![Python 3.11+](https://img.shields.io/badge/Python-3.11%2B-green)](https://python.org)
[![License](https://img.shields.io/badge/License-MIT-yellow)](LICENSE)

Real-time global intelligence across **27 domains** with **89 MCP tools**, a live ops-center dashboard, CLI reports, and per-source circuit breakers. All data comes from free, public APIs — no paid subscriptions required.
...
| **News & Media** | 3 | 80+ RSS feeds (4-tier), GDELT (8 modes), trending keywords |
...
**Total: 89 tools** across 27 intelligence domains.
...
```bash
# Clone
git clone https://github.com/marc-shade/world-events-mcp.git
cd world-events-mcp
...
```json
{
  "mcpServers": {
    "world-events-mcp": {
      "command": "/path/to/venv/bin/world-events-mcp",
      "env": {}
    }
  }
}
...
| `intel_gdelt_search` | GDELT 2.0 global news search: artlist, 6 timeline modes, tonechart, sort, date-range, sourcelang/country/theme filters |
...
1. Create `src/world_events_mcp/sources/your_source.py`
